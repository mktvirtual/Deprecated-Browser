...
DD_belatedPNG.createVmlNameSpace();DD_belatedPNG.createVmlStyleSheet();var deprecated_browser={closeDeprecated:function(){document.getElementById("deprecated_browser").style.display='none';deprecated_browser.setCookie('deprecated_browser','jabulani',2);if(document.getElementById("about_deprecated_browser"))deprecated_browser.closeFancy();},closeFancy:function(){document.getElementById("about_deprecated_browser").style.display='none';},aboutDeprecated:function(){colorBg=document.getElementById("deprecated_browser").style.backgroundColor;colorText=document.getElementById("deprecated_browser").style.color;var about_deprecated_browser=document.createElement('div');about_deprecated_browser.style.backgroundColor=colorBg;document.body.prependChild=function(newChild){this.insertBefore(newChild,this.firstChild);};document.body.prependChild(about_deprecated_browser);about_deprecated_browser.setAttribute('id','about_deprecated_browser');about_deprecated_browser.innerHTML="<div id='content_deprecated_browser'><a href='#' onClick='deprecated_browser.closeFancy()' id='close_about_deprecated_browser'><img src='http://github.com/brunomarks/updatebrowser/raw/master/images/xis.png' alt='Fechar' /></a><p class='tit_deprecated_browser'>Por que devo atualizar?</p><p id='description_deprecated_browser'>Os navegadores antigos, como o <strong>Internet Explorer 6</strong>, possuem s?rios problemas de seguran?a e n?o s?o compat?veis com muitas funcionalidades dos sites atuais. Por isso, para ter uma melhor experi?ncia de navega??o e evitar riscos com v?rus e programas espi?es, baixe gratuitamente e instale no seu computador um dos navegadores modernos dispon?veis.</p><p class='tit_deprecated_browser'>Atualize-o gratuitamente j?!</p><ul><li><a target='blank' href='http://br.mozdev.org'><img src='http://github.com/brunomarks/updatebrowser/raw/master/images/firefox_b.png' alt='Download Firefox' /></a></li><li><a target='blank' href='http://www.microsoft.com/brasil/windows/internet-explorer'><img src='http://github.com/brunomarks/updatebrowser/raw/master/images/ie_b.png' alt='Download Internet Explorer' /></a></li><li><a target='blank' href='http://www.google.com.br/chrome'><img src='http://github.com/brunomarks/updatebrowser/raw/master/images/chrome_b.png' alt='Download Chrome' /></a></li>      <li><a target='blank' href='http://www.apple.com/br/safari'><img src='http://github.com/brunomarks/updatebrowser/raw/master/images/safari_b.png' alt='Download Safari' /></a></li></ul></div>"
document.getElementById("about_deprecated_browser").style.backgroundColor=colorBg;var box_deprecated_browser=document.getElementById("content_deprecated_browser").getElementsByTagName('p');for(var i=0;i<=box_deprecated_browser.length;i++){var k=document.getElementById("content_deprecated_browser").childNodes[i];k.style.color=colorText;};},getCookie:function(c_name){if(document.cookie.length>0){c_start=document.cookie.indexOf(c_name+"=");if(c_start!=-1){c_start=c_start+c_name.length+1;c_end=document.cookie.indexOf(";",c_start);if(c_end==-1)c_end=document.cookie.length
return unescape(document.cookie.substring(c_start,c_end));}}
return false;},setCookie:function(c_name,value,expiredays){var exdate=new Date();exdate.setDate(exdate.getDate()+expiredays);document.cookie=c_name+"="+escape(value)+((expiredays==null)?"":"; expires="+exdate.toUTCString());},checkCookie:function(){var cookie_deprecated=deprecated_browser.getCookie('deprecated_browser');if(cookie_deprecated!=null&&cookie_deprecated!=""){return true;}
else{cookie_deprecated='jabulani';if(cookie_deprecated!=null&&cookie_deprecated!=""){deprecated_browser.setCookie('deprecated_browser',cookie_deprecated,2);}
return false;}},init:function(colorBg,colorText){if(this.getCookie('deprecated_browser').length>0)
return false;var headID=document.getElementsByTagName("head")[0];var cssNode=document.createElement('link');cssNode.type='text/css';cssNode.rel='stylesheet';cssNode.href='http://github.com/brunomarks/updatebrowser/raw/master/deprecated_browsers.css';cssNode.media='screen';headID.appendChild(cssNode);if(document.createElement){document.body.prependChild=function(newChild){this.insertBefore(newChild,this.firstChild);};var deprecated_browser=document.createElement('div');deprecated_browser.setAttribute('id','deprecated_browser');document.body.prependChild(deprecated_browser);deprecated_browser.style.backgroundColor=colorBg;deprecated_browser.style.color=colorText;var middle=document.createElement('div');middle.setAttribute('id','deprecated_owner');middle.style.margin='0 auto';middle.style.position='relative';middle.style.width='778px';deprecated_browser.appendChild(middle);var leftSide=document.createElement('div');var rightSide=document.createElement('div');leftSide.setAttribute('id','left_deprecated');rightSide.setAttribute('id','right_deprecated');rightSide.innerHTML='<a href="http://br.mozdev.org" class="deprecated_icon" deprecated_browser="blank"><img src="http://github.com/brunomarks/updatebrowser/raw/master/images/firefox.png" alt="Firefox" /></a><a href="http://www.microsoft.com/brasil/windows/internet-explorer" class="deprecated_icon" deprecated_browser="blank"><img src="http://github.com/brunomarks/updatebrowser/raw/master/images/ie.png" alt="Internet Explorer" /></a><a href="http://www.google.com.br/chrome" class="deprecated_icon" deprecated_browser="blank"><img src="http://github.com/brunomarks/updatebrowser/raw/master/images/chrome.png" alt="Chrome" /></a><a href="http://www.apple.com/br/safari" class="deprecated_icon" deprecated_browser="blank"><img src="http://github.com/brunomarks/updatebrowser/raw/master/images/safari.png" alt="Safari" /></a><a href="#" onClick="deprecated_browser.closeDeprecated()" id="close_deprecated"><img src="http://github.com/brunomarks/updatebrowser/raw/master/images/xis.png" alt="Fechar" /></a>';middle.appendChild(rightSide);middle.appendChild(leftSide);var logos=rightSide.getElementsByTagName('a');for(var i=logos.length-1;i>=0;i--){var k=rightSide.getElementsByTagName('a')[i];var imageAlpha=k.firstChild;imageAlpha.setAttribute('class','deprecated_browser_icob');};var closeButton=document.getElementById('close_deprecated');DD_belatedPNG.fix('img');var info=document.createElement('p');var readMoore=document.createElement('p');info.setAttribute('id','info_deprecated');info.style.color=readMoore.style.color=colorText;readMoore.setAttribute('id','info_moore_deprecated');info.innerHTML='Seu navegador ? antigo e possui s?rias falhas de seguran?a.';readMoore.innerHTML='Atualize-o gratuitamente por um dos navegadores ao lado. <a id="read_moore_link" href="#" onClick="deprecated_browser.aboutDeprecated();">Saiba mais</a>';leftSide.appendChild(info);leftSide.appendChild(readMoore);document.getElementById('read_moore_link').style.color=colorText;}}}
